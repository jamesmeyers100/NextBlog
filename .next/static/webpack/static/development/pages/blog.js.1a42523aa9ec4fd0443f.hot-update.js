...
function getMarkup() {
  return _getMarkup.apply(this, arguments);
}

function _getMarkup() {
  _getMarkup = Object(_babel_runtime_corejs2_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__["default"])(
  /*#__PURE__*/
  _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2() {
    var res, data, blogPostTest;
    return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 5:
            data = _context2.sent;
            blogPostTest = "".concat(data.items[0].content);
...
var Blog = function Blog(props) {
  ...
  }), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("ul", null, props.data.items.map(function (item) {
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 5:
          ...
          blogPostTest = data.items[0].content;
          console.log("this is blogPostTest", blogPostTest);
...
//# sourceMappingURL=blog.js.1a42523aa9ec4fd0443f.hot-update.js.map